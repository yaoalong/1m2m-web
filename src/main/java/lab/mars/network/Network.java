...
import static lab.mars.m2m.protocol.enumeration.m2m_resourceType.subscription;
...
//				{"X-M2M-RI", "00001"},
    ...
    public void createAsyncSubScriptions(String cntURI) throws Exception {
        ...
        integerList.add(m2m_resourceStatus.updated);
    ...
    private String testCreate(String parent_path, int ty, String contentFilePath, HttpResponseStatus statusCode, int flag) throws Exception {
    ...
    protected String testCreate(String parent_path, int ty, String name, String content, HttpResponseStatus statusCode, int flag) throws Exception {
        m2m_rsp m_rsp = testRequest(HttpMethod.POST, parent_path + "?ty=" + ty + (name == null ? "" : "&rn=" + name), statusCode, content);
        if (flag == ASYNC) {
            return null;
        }
